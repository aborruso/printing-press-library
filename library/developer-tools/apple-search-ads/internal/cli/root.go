...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "apple-search-ads-pp-cli",
		Short: `Apple Search Ads CLI — Every Apple Search Ads feature, plus local cost analytics, bid optimization, and cross-org templating no Python CLI off…`,
		Long: `Apple Search Ads CLI — Every Apple Search Ads feature, plus local cost analytics, bid optimization, and cross-org templating no Python CLI off…
...
Health check: run 'apple-search-ads-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("apple-search-ads-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'apple-search-ads-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBudgetordersCmd(flags))
	rootCmd.AddCommand(newCampaignsCmd(flags))
	rootCmd.AddCommand(newCreativesCmd(flags))
	rootCmd.AddCommand(newCustomReportsCmd(flags))
	rootCmd.AddCommand(newDeferredDeepLinkCmd(flags))
	rootCmd.AddCommand(newProductPageReasonsCmd(flags))
	...
	rootCmd.AddCommand(newNovelOptimizeCmd(flags))
	rootCmd.AddCommand(newNovelTemplatesCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAdgroupsPromotedCmd(flags))
	rootCmd.AddCommand(newAdsPromotedCmd(flags))
	rootCmd.AddCommand(newCountriesOrRegionsPromotedCmd(flags))
	rootCmd.AddCommand(newCreativeappmappingsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the apple-search-ads-pp-cli version string",
