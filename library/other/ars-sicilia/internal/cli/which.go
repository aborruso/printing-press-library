...
var whichIndex = []whichEntry{
	...
	{Command: "ddl cerca", Description: "Cerca disegni di legge e proposte di legge per numero, anno, legislatura, firmatario, materia o testo libero. Trovare un ddl, le proposte su un tema, quelle presentate da un deputato o dal Governo regionale.", Group: "Ricerca negli archivi", WhyItMatters: "I valori di --materia e --firmatario si chiedono con ddl materie e ddl firmatari: un valore inventato non dà errore, dà zero risultati."},
	...
	// Escape hatch.
	{Command: "ddl cerca --isis-query", Description: "Inoltra al motore di ricerca del portale un'espressione ISIS grezza, per le query che le flag ergonomiche non sanno esprimere: intervalli di date su ddl e leggi, prossimità, esclusioni combinate. Cercare i ddl presentati fra due date precise.", Group: "Potenza ai power user", WhyItMatters: "Su ddl e leggi il filtro per data non ha una flag: l'intervallo si scrive qui, in forma AAMMGG, per esempio (18.LEGISL E 260701/260814.DATPRE)."},
}
