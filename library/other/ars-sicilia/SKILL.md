...
Restano intatti i valori con parentesi (chi le scrive sta scrivendo la propria espressione), `--isis-query`, che è la via d'uscita per chi vuole comandare la sintassi, e le forme di data e numero che la CLI costruisce da sé (`260101/261231`, `2026-07-01:2026-07-31`): lì la punteggiatura è sintassi.
