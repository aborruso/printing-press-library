...
- **`ddl iter`** — Ricostruisce la cronologia completa di un disegno di legge: presentazione, passaggio in commissione, lavori d'aula, eventuale promulgazione come legge regionale.
  ...
  Gli eventi d'aula portano il numero di **`seduta`** e l'URL della scheda del resoconto (**`resoconto_url`**): serve per rispondere a «in quale seduta l'hanno votato?» e, soprattutto, per non scambiare la data della notizia con la data della seduta — la stampa scrive quasi sempre il giorno dopo.
