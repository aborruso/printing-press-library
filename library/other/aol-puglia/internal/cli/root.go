...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "aol-puglia-pp-cli",
		Short: "Manage aol-puglia resources via the aol-puglia API",
		Long: `Manage aol-puglia resources via the aol-puglia API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'aol-puglia-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("aol-puglia-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'aol-puglia-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAttiCmd(flags))
	...
	rootCmd.AddCommand(newFileexportPromotedCmd(flags))
